...
export const products: Product[] = [
  ...
  },
  {
    ...
    category: "audio",
    price: 349,
    description: "Passive two-way speakers.",
  },
  {
    id: "p4",
    ...
    category: "audio",
    price: 179,
    description: "2-in/2-out USB-C interface.",
  },
  {
    id: "p5",
    name: "4K Projector",
    category: "video",
    price: 1499,
    description: "Short-throw laser projector.",
  },
  {
    id: "p6",
    name: "Capture Card",
    category: "video",
    price: 159,
    description: "HDMI capture at 4K60.",
  },
  {
    id: "p7",
    ...
    category: "video",
    price: 999,
    description: "APS-C body with kit lens.",
  },
  {
    id: "p8",
    name: "Ring Light",
  ...
  },
  {
    ...
    category: "gaming",
    price: 299,
    description: "Force-feedback wheel and pedals.",
  },
  {
    id: "p12",
    ...
    category: "gaming",
    price: 69,
    description: "Pro controller with back paddles.",
  },
];
...
export const reviews: Review[] = [
  ...
  },
  {
    ...
    author: "Ben",
    rating: 4,
    body: "Comfortable for long sessions.",
    helpful: 0,
  },
  {
    id: "r3",
    ...
    author: "Cleo",
    rating: 4,
    body: "Clear vocals, some desk noise.",
    helpful: 1,
  },
  {
    id: "r4",
    ...
    author: "Dev",
    rating: 5,
    body: "Stunning picture in a small room.",
    helpful: 0,
  },
  {
    id: "r5",
    ...
    author: "Ana",
    rating: 3,
    body: "Good stills, average battery.",
    helpful: 0,
  },
  {
    id: "r6",
  ...
  },
  {
    ...
    author: "Fay",
    rating: 4,
    body: "Stabilizers needed tuning.",
    helpful: 0,
  },
  {
    id: "r8",
    ...
    author: "Gus",
    rating: 4,
    body: "Battery lasts about a week.",
    helpful: 0,
  },
];
...
const restockKey = (userId: string, productId: string) =>
  `${userId}:${productId}`;
